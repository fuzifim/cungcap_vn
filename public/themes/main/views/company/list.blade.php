<?
Theme::setTitle('Cung cấp doanh nghiệp'); 
Theme::setSearch('company'); 
Theme::setType('website'); 
Theme::setCanonical(route('company.list',config('app.url'))); 
$string='<script type="application/ld+json">
		{
		"@context" : "http://schema.org",
		"@type" : "WebSite",
		"name" : "Cung cấp doanh nghiệp",
		"alternateName" : "",
		"dateModified": "'.date('Y-m-d\TH:i:sP', strtotime(\Carbon\Carbon::now())).'",
		"url" : "'.route('company.list',config('app.url')).'"
		}
		</script>
	'; 
...
<div class="container">
	<div class="form-group">
		<h1 class="text-light">Cung cấp doanh nghiệp</h1> 
	</div>
